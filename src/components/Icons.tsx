...
export const BlueskyIcon: React.FC<IconProps> = ({
  ...
  <svg
    ...
    viewBox="0 0 24 24"
  >
    <path d="M12.002 2a10 10 0 0 0-10 10c0 5.523 4.477 10 10 10s10-4.477 10-10-4.477-10-10-10zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8z" />
    <path d="M8.5 14.5l3.5-3.5 3.5 3.5" />
  </svg>
);
...
// Character Icons
export const MoustacheIcon: React.FC<IconProps> = ({
  className = 'w-5 h-5',
  size = 20,
}) => (
  <svg
